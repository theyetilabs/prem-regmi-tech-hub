      ...
      <main className="container mx-auto px-6 md:px-10 lg:px-20">
        ...
        <section id="hero" className="relative min-h-screen flex flex-col justify-center items-start text-left">
          ...
          <div className="relative z-10">
            <p className="font-mono text-black mb-4">{t('heroHi')}</p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-black">
              Prem Regmi.
            </h1>
            <h2 className="mt-2 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-black">
            ...
            <button
              ...
              className="mt-12 font-mono text-white bg-black border border-black rounded px-8 py-4 hover:bg-gray-900 transition-colors duration-300"
            >
              {t('connectBtn')}
            </button>
          </div>
        ...
        <Section id="yeti-labs" title="The Yeti Labs: Our Mission">
          <div className="bg-gray-100 p-8 rounded-lg shadow-lg text-center">
            <img src="/lovable-uploads/5f1c40f8-4798-452e-8ba1-737f048eab9e.png" alt="The Yeti Labs Logo" className="h-16 w-16 mx-auto mb-4 grayscale" />
        ...
        <Section id="yeti-labs-map" title="Yeti Labs – Global Locations">
          <p className="mb-6 text-center max-w-xl mx-auto">
            Yeti Labs currently operates in <b>Nepal, USA, and Australia</b>.
          </p>
          <YetiLabsMap />
        </Section>
